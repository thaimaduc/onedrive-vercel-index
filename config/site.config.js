...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'thaimaduc@thmdc.onmicrosoft.com',
  ...
  protectedRoutes: ['/🔒 Private stuffs/📖 ACCA', '/🥟 Some test files/Protected route'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:thaimaduc@gmail.com',
